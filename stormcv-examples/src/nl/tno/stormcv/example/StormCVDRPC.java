...
import nl.tno.stormcv.example.util.FeatureMatchRequestOp;
import nl.tno.stormcv.example.util.FeatureMatchResultOp;
import nl.tno.stormcv.example.util.FeatureMatcherOp;
...
public class StormCVDRPC {
	...
	public static void main(String[] args){
		...
		System.err.println("Results for query1.png: " + drpc.execute("protomatch", "file://"+ userDir +"/resources/data/queries/query1.png"));
		System.err.println("Results for faces5.jpg: " + drpc.execute("protomatch", "file://"+ userDir +"/resources/data/faces5.jpg"));
